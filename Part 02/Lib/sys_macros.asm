;	
;**************************************************************************************************
; 	Filename:		sys_macro.asm
; 	
;
; 	Created On:		Mon Aug 28, 2017 02:05 AM	
; 	Modified On:	Wed Mar 21, 2018 10:12 PM
;
;	Comments:		This code is from the OPEN_PLAT project developed by NVR. Additional
;					macros added by me.
;
;**************************************************************************************************
;
...
;
;**************************************************************************************************
; SetBKColor [0..15] [0..15]
;**************************************************************************************************
;
.macro SetBKColor
	.if :0 < 1 .or :0 > 2
		.error "SetBKColor error"
   	.else
		.if :0 = 1
	    	lda #:1
	        sta COLBK
...
;
;**************************************************************************************************
; SetOperatingSystem [0,1]
;**************************************************************************************************
;
.macro SetOperatingSystem
	.if :0 <> 1
		.error "SetOperatingSystem error"
	.else
		.if :1 = 0
...
;
;**************************************************************************************************
; EnableOperatingSystem
;**************************************************************************************************
;
.macro EnableOperatingSystem
	.if :0 <> 0
		.error "EnableOperatingSystem error"
	.else
		SetOperatingSystem 1
	.endif
.endm
;
;**************************************************************************************************
; DisableOperatingSystem
;**************************************************************************************************
;
.macro DisableOperatingSystem
	.if :0 <> 0
		.error "DisableOperatingSystem error"
	.else
		SetOperatingSystem 0
	.endif
.endm
;
;**************************************************************************************************
...
.macro ClearSystem
	...
	.else
	    ...
	    lda #0									; clear interrupts and screen
	    sta IRQEN	
	    sta NMIEN
	    sta DMACTL
	    sta COLBK
...
;
;**************************************************************************************************
; SetDisplayListInterrupt
;**************************************************************************************************
;
.macro SetDisplayListInterrupt
	.if :0 <> 1
		.error "SetDisplayListInterrupt error"
	.else
		SetVector NMIH_VECTOR, :1
	.endif
.endm
;
;**************************************************************************************************
